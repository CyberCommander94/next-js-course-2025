  ...
  return (
    <section className="flex flex-col items-center w-full h-full">
      <div className="flex justify-end items-center w-full">
        <Link href="/top-10" className="px-2 py-2 bg-transparent border border-foreground dark:border text-center hover:text-white hover:bg-foreground dark:text-white dark:border-input dark:hover:bg-input/50">
