...
export const getAllItems = (): ShopItem[] => shopItemsData;

export const getFeaturedItems = (): ShopItem[] => shopItemsData.filter(item => item.top10);

export const getItemById = (id: string): ShopItem | undefined => shopItemsData.find(item => item.id == id);
